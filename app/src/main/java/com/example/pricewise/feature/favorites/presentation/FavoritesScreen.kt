...
import com.example.pricewise.feature.favorites.presentation.elements.DefaultButton
import com.example.pricewise.feature.favorites.presentation.elements.ProductCard
        ...
        Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            when {
                ...
                uiState.items.isEmpty() -> {
                    Text(text = "Список избранного пуст", fontSize = 16.sp, color = Color.Gray)
                }
